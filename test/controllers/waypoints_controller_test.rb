...
class WaypointsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create waypoint" do
    assert_difference('Waypoint.count') do
      post waypoints_url, params: { waypoint: { lat: @waypoint.lat, lng: @waypoint.lng, route_id: @waypoint.route_id } }, as: :json
    end
  ...
  test "should update waypoint" do
    patch waypoint_url(@waypoint), params: { waypoint: { lat: @waypoint.lat, lng: @waypoint.lng, route_id: @waypoint.route_id } }, as: :json
    assert_response 200
  end
